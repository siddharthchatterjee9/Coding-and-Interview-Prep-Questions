...
public class Kata5 {
    ...
    public void tests() {
        ...
        assertEquals("found the needle at position 3", Haystack.findNeedle(haystack1));
        assertEquals("found the needle at position 5", Haystack.findNeedle(haystack2));
        assertEquals("found the needle at position 30", Haystack.findNeedle(haystack3));
    }
}
class Haystack {
